...
import { MessageCircle, Repeat2, Heart, User } from 'lucide-react';
      ...
      <div className="flex items-center mb-3">
        ...
        <div>
          <div className="flex items-center">
            <span className="font-semibold text-gray-900 text-sm mr-2">{news.author}</span>
            <span className="text-blue-500 text-xs font-medium mr-2">• {news.category}</span>
