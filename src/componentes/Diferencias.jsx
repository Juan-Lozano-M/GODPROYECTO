...
import { Users, Target, Heart, Play, Zap, ArrowRight } from 'lucide-react';
         ...
         <div className="mb-10 md:mb-12">
          ...
          <div className="space-y-4 md:space-y-0 md:grid md:grid-cols-3 md:gap-6">
            {(activeTab === 'tradicional' ? metodosTradicionales : enfoqueGOD).map((item, index) => (
              <div 
                key={index}
                className="group relative p-6 rounded-2xl transition-all duration-300 hover:-translate-y-1 bg-white border border-black hover:shadow-lg h-48 flex flex-col"
                style={{
