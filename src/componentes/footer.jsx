        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="lg:col-span-1">
              <div className="mb-6">
                ...
                <p className="text-gray-400 mt-2 text-sm leading-relaxed">
                  Donde los sueños se convierten en realidad a través del juego.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              ...
              <nav className="space-y-3">
                {['Home', 'Sobre Nosotros', 'Juegos', 'Política de Privacidad'].map((item) => (
                  <a
                    key={item}
                    href="#"
            ...
            <div className="lg:col-span-1">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 group">
                  ...
                  <a href="mailto:gameofdreams@gmail.com" className="text-gray-300 hover:text-[#A4FF00] transition-colors">
                ...
                <div className="flex items-center space-x-3 group">
                  ...
                  <a href="tel:+420776658505" className="text-gray-300 hover:text-[#A4FF00] transition-colors">
                    +420 776 658 505
                  </a>
                </div>
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
            ...
            <div className="flex space-x-6">
              <a href="#" className="hover:text-[#A4FF00] transition-colors">Términos de Uso</a>
              <a href="#" className="hover:text-[#A4FF00] transition-colors">Privacidad</a>
              <a href="#" className="hover:text-[#A4FF00] transition-colors">Cookies</a>
            </div>
          </div>
        </div>
      </div>
