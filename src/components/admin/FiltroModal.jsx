...
const FiltroModal = ({ filters, activeFilter, setActiveFilter, onClose }) => {
  // Variantes para las animaciones (las mismas que TestimonialModal)
  ...
  return (
    <AnimatePresence>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        ...
        >
          {/* Botón de cerrar con rotación al hover */}
          ...
          >
            <motion.h2 
              ...
              className="text-2xl font-adlam text-center"
            >
