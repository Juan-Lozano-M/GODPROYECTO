const NoticeCard = ({ image, name, title }) => {
    return (
      <div className="flex items-center w-full h-20 sm:h-34 bg-black/7 rounded-sm">
        <img src={image} className="h-full sm:w-50 rounded-lg" alt={`Imagen de ${name}`} />
        <div className="flex justify-between items-center w-full h-full">
          <div className="flex flex-col ml-10">
              <h1 className="text-[15px] sm:text-[20px] xl:text-[18px] 2xl:text-2xl font-adlam">Semana del emprendimiento 2025</h1>
              <p className="text-[11px] sm:text-[15px] xl:text-[12px] 2xl:text-[15px] font-bold mr-2 text-[#3E3E3E]">Redactado por: Gloria Valero - 25/04/2025</p>
              <p className="text-lg font-adlam mt-4"> Una iniciativa para fortalecer ideas de negocio... </p>
          </div>
